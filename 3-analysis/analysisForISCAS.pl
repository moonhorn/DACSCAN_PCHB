...
`mkdir ../0-result/ISCAS/analysis/FC`;
    ...
    @STR_DT  = <../0-result/ISCAS/tmax/DT/STR/$bench*.dt>;
    @STF_DT  = <../0-result/ISCAS/tmax/DT/STF/$bench*.dt>;
    @STR_UD  = <../0-result/ISCAS/tmax/UD/STR/$bench*.ud>;
    @STF_UD  = <../0-result/ISCAS/tmax/UD/STF/$bench*.ud>;
    @STR_AU  = <../0-result/ISCAS/tmax/AU/STR/$bench*.au>;
    @STF_AU  = <../0-result/ISCAS/tmax/AU/STF/$bench*.au>;
    @STR_ND  = <../0-result/ISCAS/tmax/ND/STR/$bench*.nd>;
    @STF_ND  = <../0-result/ISCAS/tmax/ND/STF/$bench*.nd>;
    @STR_LOG = <../0-result/ISCAS/tmax/LOG/STR/$bench*.log>;
    @STF_LOG = <../0-result/ISCAS/tmax/LOG/STF/$bench*.log>;
    ...
    {  
        ...
        open( FOUT_DT, "> ../0-result/ISCAS/analysis/DT/".$netlist."_".$TF.".dt") or die "Can't write total.dt";
        open( FOUT_UD, "> ../0-result/ISCAS/analysis/UD/".$netlist."_".$TF.".ud") or die "Can't write total.ud";
        open( FOUT_ND, "> ../0-result/ISCAS/analysis/ND/".$netlist."_".$TF.".nd") or die "Can't write total.nd";
        open( FOUT_FC, "> ../0-result/ISCAS/analysis/FC/".$netlist."_".$TF.".fc") or die "Can't write total.fc";
